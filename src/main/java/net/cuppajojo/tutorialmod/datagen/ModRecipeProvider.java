...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        offerReversibleCompactingRecipes(exporter, RecipeCategory.MISC, ModItems.CUPPAJOJO_SAD, RecipeCategory.DECORATIONS, ModBlocks.CUPPAJOJO_SAD_BLOCK);
        offerReversibleCompactingRecipes(exporter, RecipeCategory.MISC, ModItems.CUPPAJOJO_SMILE, RecipeCategory.DECORATIONS, ModBlocks.CUPPAJOJO_SMILE_BLOCK);
